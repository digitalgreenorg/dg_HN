    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_created', models.ForeignKey(related_name=b'activities_personadoptpractice_created', blank=True, editable=False, to=settings.AUTH_USER_MODEL, null=True)),
                ('user_modified', models.ForeignKey(related_name=b'activities_personadoptpractice_related_modified', blank=True, editable=False, to=settings.AUTH_USER_MODEL, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('expressed_adoption_video', models.ForeignKey(related_name=b'expressed_adoption_video', blank=True, to='videos.Video', null=True)),
                ('person', models.ForeignKey(to='people.Person')),
            ],
            options={
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('partner', models.ForeignKey(to='programs.Partner')),
                ('user_created', models.ForeignKey(related_name=b'activities_screening_created', blank=True, editable=False, to=settings.AUTH_USER_MODEL, null=True)),
                ('user_modified', models.ForeignKey(related_name=b'activities_screening_related_modified', blank=True, editable=False, to=settings.AUTH_USER_MODEL, null=True)),
        ...
        migrations.AddField(
            model_name='personmeetingattendance',
            name='user_created',
            field=models.ForeignKey(related_name=b'activities_personmeetingattendance_created', blank=True, editable=False, to=settings.AUTH_USER_MODEL, null=True),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='personmeetingattendance',
            name='user_modified',
            field=models.ForeignKey(related_name=b'activities_personmeetingattendance_related_modified', blank=True, editable=False, to=settings.AUTH_USER_MODEL, null=True),
            preserve_default=True,
        ),
        migrations.AlterUniqueTogether(
            name='personadoptpractice',
        ...
        migrations.AddField(
            model_name='jslps_screening',
            name='user_created',
            field=models.ForeignKey(related_name=b'activities_jslps_screening_created', blank=True, editable=False, to=settings.AUTH_USER_MODEL, null=True),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='jslps_screening',
            name='user_modified',
            field=models.ForeignKey(related_name=b'activities_jslps_screening_related_modified', blank=True, editable=False, to=settings.AUTH_USER_MODEL, null=True),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='jslps_pma',
            name='pma',
            field=models.ForeignKey(blank=True, to='activities.PersonMeetingAttendance', null=True),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='jslps_pma',
            name='user_created',
            field=models.ForeignKey(related_name=b'activities_jslps_pma_created', blank=True, editable=False, to=settings.AUTH_USER_MODEL, null=True),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='jslps_pma',
            name='user_modified',
            field=models.ForeignKey(related_name=b'activities_jslps_pma_related_modified', blank=True, editable=False, to=settings.AUTH_USER_MODEL, null=True),
            preserve_default=True,
        ),
    ]
