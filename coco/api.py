...
class PersonAdoptVideoResource(BaseResource):
    ...
    class Meta:
        max_limit = None
        queryset = PersonAdoptPractice.objects.prefetch_related('person__village','video', 'animator', 'person__group', 'person', 'partner').filter(date_of_verification__gte=datetime(2013,1,1))
